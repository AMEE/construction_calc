...
class Material < ActiveRecord::Base
  ...
  TYPE = {
    ...
    :plastic => AmeeCategory.new("Plastic", :weight, "/embodied/ice", :material => "plastics", :type => "general", :unit_conversions => {:kg => [:m3 => 1000]}),
    ...
    :copper => AmeeCategory.new("Copper", :weight, "/embodied/ice", :material => "copper", :type => "primary", :unit_conversions => {:kg => [:m3 => 8930]}),
